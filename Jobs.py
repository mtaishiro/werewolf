...
def werewolf(playerlist1):
    print("Who would you like to atttack tonight?")
    print(playerlist1)
    print()
    victim = input("Your choice: ")
    return victim

def knight(playerlist1):
    print("Who would you like to protect tonight?")
    print(playerlist1)
    print()
    protected = input("Your choice: ")
    return protected


for i in range(3):
    fortuneteller(playerlist, playerjob)
    ...
    if victim == protected:
        #守られたため何も起こらない
        print('The attack from the werewolf failed!')
